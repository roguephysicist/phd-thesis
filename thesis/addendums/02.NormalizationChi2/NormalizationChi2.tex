...
is $V = L^{3}$. We calculate $\boldsymbol{\chi}(-2\omega;\omega,\omega)$
...
Lastly, let us consider the case for two-dimensional materials, as depicted in
Fig. \ref{fig:2d}. These types of materials are essentially a combination of the
two previous cases; namely, they must have a vacuum region included, but do not
require restricting the calculated response to the just the half-slab region.
