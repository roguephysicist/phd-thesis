...
\section{The Necessary Equations}
...
{Polarization unit vectors for $\hat{\mathbf{e}}^{\mathrm{out}}$ and
...
\section{\texorpdfstring{$\mathcal{R}_{pP}$}{RpP} (\emph{p}-in, \emph{P}-out)}
...
\section{\texorpdfstring{$\mathcal{R}_{pS}$}{RpS} (\emph{p}-in, \emph{S}-out)}
...
\section{\texorpdfstring{$\mathcal{R}_{sP}$}{RsP} (\emph{s}-in, \emph{P}-out)}
...
\section{\texorpdfstring{$\mathcal{R}_{sS}$}{RsS} (\emph{s}-in, \emph{S}-out)}
