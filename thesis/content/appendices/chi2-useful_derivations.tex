...
&=  -\frac{e^{3}}{\hbar^2}\sum_{mn\mathbf{k}}\left[\frac{4f_{mn}\,\mathrm{Re}
    ...
    \frac{1}{\omega^{\Sigma}_{nm}-2\tilde\omega}\nonumber\\
&=  \frac{\vert e\vert^3}{2\hbar^2}\sum_{mn\mathbf{k}}
...
\begin{equation}\label{imchi2w}
    \mathrm{Im}[\chi_{i,2\omega}^{\mathrm{abc}}] 
...
I_{\omega}
= -\frac{e^3}{\hbar^2}\sum_{nm\mathbf{k}}
\Biggl[
-   \frac{f_{mn}\,\mathrm{Re}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    \left(r^{\text{LDA,b}}_{nm}\right)_{;k^{\text{c}}}\right]}
    {(\omega^{\Sigma}_{nm})^{2}}
&+  \frac{3f_{mn}\,\mathrm{Re}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{LDA,b}}_{nm}\right]
    \Delta^{\text{c}}_{nm}}{(\omega^{\Sigma}_{nm})^{3}}
    \nonumber\\
+   \frac{f_{mn}\,\mathrm{Re}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    \left(r^{\text{LDA,b}}_{nm}\right)_{;k^{\text{c}}}\right]}
    {(\omega^{\Sigma}_{nm})^{2}}
&-  \frac{2f_{mn}\,\mathrm{Re}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{nm}
    r^{\text{LDA,b}}_{mn}\right]
    \Delta_{nm}^{\text{c}}}{(\omega^{\Sigma}_{nm})^{3}}
    \nonumber\\
&+  \frac{f_{mn}\,\mathrm{Re}\left[r^{\text{LDA,b}}_{nm}
    \left(\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}\right)
...
I_{\omega}
=   \frac{\vert e\vert^3}{2\hbar^2}\sum_{nm\mathbf{k}}
    \frac{f_{mn}}{(\omega^{\Sigma}_{nm})^{2}}
\Biggl[
    \mathrm{Re}\left[r^{\text{LDA,b}}_{nm}
    \left(\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}\right)_{;k^{\text{c}}}\right]
+   \frac{\mathrm{Re}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{LDA,b}}_{nm}\right]\Delta^{\text{c}}_{nm}}{\omega^{\Sigma}_{nm}} 
\Biggr]\frac{1}{\omega^{\Sigma}_{nm}-\tilde\omega},
\end{equation}
where we added a $1/2$ from the sum over $\mathbf{k} \rightarrow -
\mathbf{k}$, and using \eqref{limit_eta} we obtain our final form,
\begin{equation}
\mathrm{Im}[\chi_{i,\omega}^{\mathrm{abc}}]
...
E&=
\frac{ie^{3}}{\hbar^{2}}\Bigg(A
\left[
-\frac{1}{2\omega^\Sigma_{qm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{qm}-\tilde\omega}
+\frac{2}{\omega^\Sigma_{nm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{nm}-2\tilde\omega}
+\frac{1}{2\omega^\Sigma_{qm}\omega^\Sigma_{nm}}
 \frac{1}{\tilde\omega}
\right]
\nonumber\\
&- B
\left[
-\frac{1}{2\omega^\Sigma_{nq}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{nq}-\tilde\omega}
+\frac{2}{\omega^\Sigma_{nm}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{nm}-2\tilde\omega}
+\frac{1}{2\omega^\Sigma_{nq}\omega^\Sigma_{nm}}
 \frac{1}{\tilde\omega}
\right]\Bigg),
\end{align}  
where 
$A=f_{mq}\mathcal{V}^{\Sigma,\text{a}}_{mn}r^{\text{c}}_{nq}r^{\text{b}}_{qm}$   
and
$B=f_{qn}\mathcal{V}^{\Sigma,\text{a}}_{mn}r^{\text{b}}_{nq}r^{\text{c}}_{qm}$.
Just as above, the $\frac{1}{\tilde\omega}$ terms cancel out. We multiply out
the $A$ and $B$ terms,
\begin{align}\label{emultipied}  
E&=  
\frac{ie^{3}}{\hbar^{2}}\Bigg(
\left[
-\frac{A}{2\omega^\Sigma_{qm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{qm}-\tilde\omega}
+\frac{2A}{\omega^\Sigma_{nm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{nm}-2\tilde\omega}
\right]\nonumber\\
&+ 
\left[
 \frac{B}{2\omega^\Sigma_{nq}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{nq}-\tilde\omega}
-\frac{2B}{\omega^\Sigma_{nm}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
 \frac{1}{\omega^\Sigma_{nm}-2\tilde\omega}
\right]\Bigg).
\end{align}  
...
Starting with $A$,
\begin{align*}
A \rightarrow f_{mq}\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{c}}_{nq}r^{\text{b}}_{qm}\vert_{\mathbf{k}}
&+  f_{mq}\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}r^{\text{c}}_{nq}
    r^{\text{b}}_{qm}\vert_{-\mathbf{k}}\nonumber\\
&=  f_{mq}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{c}}_{nq}r^{\text{b}}_{qm}\vert_{\mathbf{k}} 
+   \left(-\mathcal{V}^{\Sigma,\text{a},\ell}_{nm}\right)
    r^{\text{c}}_{qn}r^{\text{b}}_{mq}\vert_{\mathbf{k}}\right]\nonumber\\
&=  f_{mq}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{c}}_{nq}r^{\text{b}}_{qm} 
-   \mathcal{V}^{\Sigma,\text{a},\ell}_{nm}
    r^{\text{c}}_{qn}r^{\text{b}}_{mq}\right]\nonumber\\
&=  f_{mq}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{c}}_{nq}r^{\text{b}}_{qm}
-   \left(\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{c}}_{nq}r^{\text{b}}_{qm}\right)^{*}\right]\nonumber\\
&=  2if_{mq}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{c}}_{nq}r^{\text{b}}_{qm}\right],
\end{align*}
then $B$,
\begin{align*}
B \rightarrow f_{qn}\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{b}}_{nq}r^{\text{c}}_{qm}\vert_{\mathbf{k}}
&+  f_{qn}\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}r^{\text{b}}_{nq}
    r^{\text{c}}_{qm}\vert_{-\mathbf{k}}\nonumber\\
&=  f_{qn}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{b}}_{nq}r^{\text{c}}_{qm}\vert_{\mathbf{k}} 
+   \left(-\mathcal{V}^{\Sigma,\text{a},\ell}_{nm}\right)
    r^{\text{b}}_{qn}r^{\text{c}}_{mq}\vert_{\mathbf{k}}\right]\nonumber\\
&=  f_{qn}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{b}}_{nq}r^{\text{c}}_{qm} 
-   \mathcal{V}^{\Sigma,\text{a},\ell}_{nm}
    r^{\text{b}}_{qn}r^{\text{c}}_{mq}\right]\nonumber\\
&=  f_{qn}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{b}}_{nq}r^{\text{c}}_{qm}
-   \left(\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{b}}_{nq}r^{\text{c}}_{qm}\right)^{*}\right]\nonumber\\
&=  2if_{qn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
    r^{\text{b}}_{nq}r^{\text{c}}_{qm}\right].
\end{align*}
...
\frac{e^{3}}{\hbar^{2}}\Bigg(
\Bigg[
  \frac{2f_{mq}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{c}}_{nq}
        r^{\text{b}}_{qm}\right]}
        {2\omega^\Sigma_{qm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
\frac{1}{\omega^\Sigma_{qm}-\tilde\omega}
&-\frac{4f_{mq}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{c}}_{nq}
        r^{\text{b}}_{qm}\right]}
        {\omega^\Sigma_{nm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
\frac{1}{\omega^\Sigma_{nm}-2\tilde\omega}\nonumber\\
-\frac{2f_{qn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{b}}_{nq}
        r^{\text{c}}_{qm}\right]}
        {2\omega^\Sigma_{nq}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
\frac{1}{\omega^\Sigma_{nq}-\tilde\omega}
&+\frac{4f_{qn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{b}}_{nq}
        r^{\text{c}}_{qm}\right]}
        {\omega^\Sigma_{nm}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
\frac{1}{\omega^\Sigma_{nm}-2\tilde\omega}
\Bigg]\Bigg)
.
\end{align*}
We exchange $n\leftrightarrow q$ ($m\leftrightarrow q$) in the first (second)
term,
\begin{align*}
E &=  
\frac{e^{3}}{\hbar^{2}}\Bigg(
\Bigg[
  \frac{f_{mq}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{c}}_{nq}
        r^{\text{b}}_{qm}\right]}
        {\omega^\Sigma_{qm}(2\omega^\Sigma_{qm}-\omega^\Sigma_{nm})}
\frac{1}{\omega^\Sigma_{qm}-\tilde\omega}
 -\frac{f_{qn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{b}}_{nq}
        r^{\text{c}}_{qm}\right]}
        {\omega^\Sigma_{nq}(2\omega^\Sigma_{nq}-\omega^\Sigma_{nm})}
\frac{1}{\omega^\Sigma_{nq}-\tilde\omega}
\Bigg]\nonumber\\
&\qquad+
\Bigg[
  \frac{f_{qn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{b}}_{nq}
        r^{\text{c}}_{qm}\right]}
        {2\omega^\Sigma_{nq}-\omega^\Sigma_{nm}}
 -\frac{f_{mq}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        r^{\text{c}}_{nq}
        r^{\text{b}}_{qm}\right]}
        {2\omega^\Sigma_{qm}-\omega^\Sigma_{nm}}
...
\frac{e^{3}}{\hbar^{2}}\Bigg(
\Bigg[
  \frac{f_{mn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mq}
        r^{\text{c}}_{qn}
        r^{\text{b}}_{nm}\right]}
        {2\omega^\Sigma_{nm}-\omega^\Sigma_{qm}}
 -\frac{f_{mn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{qn}
        r^{\text{b}}_{nm}
        r^{\text{c}}_{mq}\right]}
        {2\omega^\Sigma_{nm}-\omega^\Sigma_{nq}}
...
\begin{align*}
E = \frac{e^3}{2\hbar^2}\sum_{nm}\frac{f_{mn}}{\omega^\Sigma_{nm}}
&\left[
  \frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mq}
        \{r^{\text{c}}_{qn}
        r^{\text{b}}_{nm}\}\right]}
        {2\omega^\Sigma_{nm}-\omega^\Sigma_{qm}}
 -\frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{qn}
        \{r^{\text{b}}_{nm}
        r^{\text{c}}_{mq}\}\right]}
        {2\omega^\Sigma_{nm}-\omega^\Sigma_{nq}}
\right]\frac{1}{\omega^\Sigma_{nm}-\tilde\omega}\nonumber\\
+
\frac{4}{\omega^\Sigma_{nm}}&\left[
  \frac{f_{qn}\,\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{mn}
        \{r^{\text{b}}_{nq}
        r^{\text{c}}_{qm}\}\right]}
        {2\omega^\Sigma_{nq}-\omega^\Sigma_{nm}}
...
\end{align*}
where we added a $1/2$ from the sum over $\mathbf{k} \rightarrow -
\mathbf{k}$. Finally, we take $n = c$, and $m = v$ and substitute,
\begin{align*}
E &= -\frac{\vert e\vert^3}{2\hbar^2}\sum_{cv}\frac{1}{\omega^\Sigma_{cv}}
  \left(\left[
...
&= \frac{\vert e\vert^3}{2\hbar^2}\sum_{cv}\frac{1}{\omega^\Sigma_{cv}}
\left(\left[
...
\begin{align*}
\mathrm{Im}[\chi^{\mathrm{abc}}_{e}] = \frac{\pi|e^3|}{2\hbar^2}\sum_{cv}\frac{1}{\omega^\Sigma_{cv}}
&\left(\left[
 \frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{qc}
        \{r^{\text{b}}_{cv}
        r^{\text{c}}_{vq}\}\right]}
...
\begin{align*}  
\mathrm{Im}[\chi^{\mathrm{abc}}_{e}] =
\frac{\pi|e^3|}{2\hbar^2}\sum_{cv}\frac{1}{\omega^\Sigma_{cv}}
&\left(
\sum_{q\neq (v,c)}
\left[
 \frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{qc}
...
Therefore
\begin{equation*}  
\mathrm{Im}[\chi^{\mathrm{abc}}_{e,\omega}] =
\frac{\pi|e^3|}{2\hbar^2}\sum_{cv}\frac{1}{\omega^\Sigma_{cv}}
\sum_{q\neq (v,c)}
\left[
 \frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{qc}
...
and
\begin{equation*}  
\mathrm{Im}[\chi^{\mathrm{abc}}_{e,2\omega}] =
-\frac{\pi|e^3|}{2\hbar^2}\sum_{cv}\frac{4}{\omega^\Sigma_{cv}}
\left[
 \sum_{v^{\prime}\neq v}
  \frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{vc}
        \{r^{\text{b}}_{cv^{\prime}}
 ...
 \frac{\mathrm{Im}\left[\mathcal{V}^{\Sigma,\text{a},\ell}_{vc}
        ...
        r^{\text{b}}_{c^{\prime}v}\}\right]}
        {2\omega^\Sigma_{c^{\prime}v}-\omega^\Sigma_{cv}}
\right]\delta(\omega^{\Sigma}_{cv}-2\omega).
\end{equation*}
...
.
\end{align} 
For a full-slab calculation, that would correspond to a bulk calculation as
well, $C^{\ell}(z)=1$ and then, $C^{\ell}_{nm}=\delta_{nm}$, and from above
expression $\mathcal{T}^{\mathrm{a}\mathrm{b}}_{nm}\to
\tau^{\mathrm{a}\mathrm{b}}_{nm}$. Thus, the layered expression for
$\mathcal{V}^{\mathrm{LDA},a}_{nm}$ becomes
