...
% right side
\node at (18.05,6.5) {\LARGE $\epsilon_{v}=1$};
\node at (-1.9,6.0) {\Large Vacuum};
\node at (19,5.1) {\LARGE $z = 0$};
\node [text width=2cm,align=right] at (-2.05,3.5) {\Large Surface\\[2pt] Layer};
\node at (17.5,3.5) {\LARGE $\epsilon_{\ell}$};
\node at (19,2.1) {\LARGE $z = -d$};
\node at (-1.55,1) {\Large Bulk};
\node at (17.5,1) {\LARGE $\epsilon_{b}$};
% surface
