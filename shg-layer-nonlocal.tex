...
found in
Ref. \ref{sipe00} and \ref{lambrecht00}.
...
the equivalent of Eq.~\eqref{nl.4} for $\calbv^\ell=\calbp^\ell/m_e$
 was proposed 
in Ref.~\ref{reiningPRB94}, and latter used in Refs.
\ref{mendozaPRB01} 
and \ref{mejiaSMF04} in the context of SHG. Then, 
the layer-by-layer analysis of Refs. \ref{hoganPRB03} 
and \ref{castilloPRB03}
...
Ref.~\ref{mendozaPRB06} for the linear optical response, and
...
\appendix
\input{appendix-div_free_exp_chi}
\input{appendix-calv}
\input{appendix-dirac}
\input{appendix-basic_relationships}
\input{appendix-gen_der_omega}
\input{appendix-gen_der_r}
\input{appendix-gen_der_r_nonlocal}
\input{appendix-matrix_elements}
\input{appendix-gen_der_calv}
\input{appendix-gen_der_calr}
\input{appendix-exp_calp}
\input{appendix-odds_ends}
\input{appendix-re_ri}
