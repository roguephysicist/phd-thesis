...
\begin{figure}
\raggedright
\includegraphics[height=0.45\textheight]{fig-Si1x1-Mejia_RpP}
\end{figure}
\vspace{-0.5cm}
\begin{figure}
\raggedleft
\includegraphics[height=0.45\textheight]{fig-Si1x1-Mejia_RpP_models}
\end{figure}
\end{frame}
...
\item \emph{Zapata-Pe\~na, Anderson, et al.}, Phys. Status Solidi B 253, 408 (2016) % COVER PAGE
