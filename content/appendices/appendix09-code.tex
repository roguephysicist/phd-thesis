...
\begin{figure}[b]
\centering
\includegraphics[scale=.7]{figures/appendices/shg-bulk}
...
\begin{figure}[b]
\centering
\includegraphics[scale=.7]{figures/appendices/surface-chi}
\caption{Im[$\chi_{xx}$] 
...
\begin{figure}[b]
\centering 
\includegraphics[scale=.7]{figures/appendices/shg-si-2x1-16}
\caption{$|\chi_{xxx}|$ 
...
\begin{figure}[b]
\centering
\includegraphics[scale=.7]{figures/appendices/shg-si-2x1-n-vs-b}
\caption{$|\chi_{xxx}|$ 
...
\begin{figure}[b]
\centering 
\includegraphics[scale=1.5]{figures/appendices/shg-si-2x1-16-compa}
\caption{$|\chi_{xxx}|$ 
for a Si(100)$2\times 1$ surface of 16 Si-layers and one H layer, 10 
