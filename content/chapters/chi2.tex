...
\equiv P^{\mathrm{a}}_{\mathrm{aurface}}
...
%=\frac{\Delta f_{mn}}{\omega^{\mathrm{LDA}}_{nm}}\mathbf{v}^\mathrm{LDA}_{nm}
\end{equation}
with $f_{nm}=f_n-f_m$,
...
\nonumber\\
&=
\mathbf{v}^\mathrm{LDA}_{nm}+i\Delta f_{mn}\frac{\mathbf{v}^\Sigma_{nm}(\mathbf{k})}{i\omega^\Sigma_{nm}(\mathbf{k})}
\nonumber\\
\mathbf{v}^\Sigma_{nm}
...
\end{align}
since
$\omega^\Sigma_{nm}-\Delta f_{mn}=\omega^{\mathrm{LDA}}_{nm}$. Therefore, 
...
=\left(1+\frac{\Delta}{\omega_c(\mathbf{k})-\omega_v(\mathbf{k})}\right)\mathbf{v}^\mathrm{LDA}_{nm}(\mathbf{k})
\quad\quad n\notin D_m
\nonumber\\
