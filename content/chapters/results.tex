...
{\includegraphics[width=0.3\textwidth]{content/figures/struc-Si2x1front}}\hfill
\subbottom[Side view.\label{fig:2x1side}]%
{\includegraphics[width=0.3\textwidth]{content/figures/struc-Si2x1side}}\hfill
\subbottom[Top view.\label{fig:2x1top}]%
{\includegraphics[width=0.3\textwidth]{content/figures/struc-Si2x1top}}
...
\begin{figure}[H]
\centering 
\includegraphics[width=0.5\textwidth]{content/figures/struc-Si2x1rot}
...
\begin{figure}[H]
\centering 
\includegraphics[width=0.5\textwidth]{content/figures/{fig-4_1_05}}
\caption{$\chi^{xxx}_{\mathrm{half-slab}}$ vs $\hbar\omega$ for a slab with 32
...
\section{Calculating \texorpdfstring{$\boldsymbol{\chi}$}{X} for the
\texorpdfstring{Si(111)(1$\times$1):H}{Si(111)(1x1):H} surface}
\label{sec:res1x1chi}

In this section I present the calculation of
$\boldsymbol{\chi}$ for the Si(111)(1$\times$1):H
...
\subbottom[Front view.\label{fig:1x1front}]%
    {\includegraphics[width=0.3\textwidth]{content/figures/struc-Si1x1front}}\hfill
\subbottom[Side view.\label{fig:1x1side}]%
    {\includegraphics[width=0.3\textwidth]{content/figures/struc-Si1x1side}}\hfill
\subbottom[Top view.\label{fig:1x1top}]%
    {\includegraphics[width=0.3\textwidth]{content/figures/struc-Si1x1top}}
...
\subbottom[$\mathcal{R}_{pP}$\label{fig:2x1rpp3d}]%
    {\includegraphics[height=0.40\textwidth]{content/figures/fig-4_2_01}}\hfill
\subbottom[$\mathcal{R}_{sP}$\label{fig:2x1rsp3d}]%
    {\includegraphics[height=0.40\textwidth]{content/figures/fig-4_2_02}}
...
\subbottom[$\mathcal{R}_{pS}$\label{fig:2x1rps3d}]%
    {\includegraphics[height=0.40\textwidth]{content/figures/fig-4_2_03}}\hfill
\subbottom[$\mathcal{R}_{sS}$\label{fig:2x1rss3d}]%
    {\includegraphics[height=0.40\textwidth]{content/figures/fig-4_2_04}}
...
\subbottom[$\mathcal{R}_{pP}$\label{fig:1x1rpp3d}]%
    {\includegraphics[height=0.38\textwidth]{content/figures/3D-Si1x1-RpP}}\hfill
\subbottom[$\mathcal{R}_{sP}$\label{fig:1x1rsp3d}]%
    {\includegraphics[height=0.38\textwidth]{content/figures/3D-Si1x1-RsP}}
...
\subbottom[$\mathcal{R}_{pS}$\label{fig:1x1rps3d}]%
    {\includegraphics[height=0.38\textwidth]{content/figures/3D-Si1x1-RpS}}\hfill
\subbottom[$\mathcal{R}_{sS}$\label{fig:1x1rss3d}]%
    {\includegraphics[height=0.38\textwidth]{content/figures/3D-Si1x1-RsS}}
