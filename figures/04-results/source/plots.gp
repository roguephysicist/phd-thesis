...
p "../data/Si1x1/mejia.3layer.dat" u (2*$1):3      t '3-layer'                     dt 1 lw 4.0 lc rgb "#268bd2" w l,\
  "../data/Si1x1/mejia.bulk.dat"   u (2*$1):($3*2) t '2-layer-bulk ($\times 2$)'   dt 1 lw 2.0 lc rgb "#dc322f" w l,\
  "../data/Si1x1/mejia.2layer.dat" u (2*$1):($3*2) t '2-layer-vacuum ($\times 2$)' dt 3 lw 4.0 lc rgb "#1ba362" w l,\
...
p "../data/Si1x1/mitchell.3layer.dat" u (2*$1):($3*2.4) t '3-layer ($\times 2.4$)'        dt 1 lw 4.0 lc rgb "#268bd2" w l,\
  "../data/Si1x1/mitchell.2layer.dat" u (2*$1):($3*2.4) t '2-layer-vacuum ($\times 2.4$)' dt 1 lw 2.0 lc rgb "#dc322f" w l,\
...
p "../data/Si1x1/mejia.3layer.dat" u (2*$1):4        t '3-layer'                        dt 1 lw 4.0 lc rgb "#268bd2" w l,\
  "../data/Si1x1/mejia.2layer.dat" u (2*$1):($4/100) t '2-layer-vacuum ($\times 0.01$)' dt 4 lw 4.0 lc rgb "#dc322f" w l,\
...
p "../data/Si1x1/mejia.3layer.dat" u (2*$1):($2/2)  t '3-layer ($\times 0.5$)'         dt 1 lw 4.0 lc rgb "#268bd2" w l,\
  "../data/Si1x1/mejia.2layer.dat" u (2*$1):($2/30) t '2-layer-vacuum ($\times 1/30$)' dt 4 lw 4.0 lc rgb "#dc322f" w l,\
...
set xlabel 'Two-photon energy (eV)'
set ylabel '$\mathcal{R}_{pP}\, (10^{-20} \times \mathrm{cm}^{2}/\mathrm{W})$'
p "../data/Si1x1/mejia.bulk.dat"   u (2*$1):($2*4)    t '2-layer-bulk ($\times 4$)'                dt 1 lw 4.0 lc rgb "#1ba362" w l,\
  "../data/Si1x1/mejia.hybrid.dat" u (2*$1):($2*2.4)  t '3-layer-bulk ($\times 2.4$)'              dt 1 lw 2.0 lc rgb "#e6ac00" w l,\
  "../data/Si1x1/mejia.vacuum.dat" u (2*$1):($2*3e-5) t '$\emph{Vacuum}$ ($\times 3\mathrm{E}-5$)' dt 2 lw 4.0 lc rgb "#dc322f" w l,\
  "../data/experiment/mejiaPRB02_bergfeldPRL04.dat" u 1:($2/100) t 'Experiment' pt 1 ps 1 lw 2 lc rgb "black" w p
####
...
p "../data/Si1x1/mitchell.3layer.dat" u (2*$1):2       t '3-layer'                        dt 1 lw 4.0 lc rgb "#268bd2" w l,\
  "../data/Si1x1/mitchell.2layer.dat" u (2*$1):($2/20) t '2-layer-vacuum ($\times 1/20$)' dt 4 lw 4.0 lc rgb "#dc322f" w l,\
