...
\section{\texorpdfstring{SHG yield per Sipe, Moss, and van Driel
\cite{sipePRB87}} {SHG yield per Sipe, Moss, and van Driel}}

In this treatment, they define the following for all polarizations;
...
\section{\texorpdfstring{SHG yield per Mizrahi and Sipe
\cite{mizrahiJOSA88}}{SHG yield per Mizrahi and Sipe}}
\subsection{\texorpdfstring{$\mathcal{R}_{pP}$}{RpP}}
\subsection{\texorpdfstring{$\mathcal{R}_{pS}$}{RpS}}
\subsection{\texorpdfstring{$\mathcal{R}_{sP}$}{RsP}}
\subsection{Summary}
...
\section{\texorpdfstring{SHG yield per Mendoza \cite{mendozaEPI04}}{SHG yield
per Mendoza}}
\subsection{\texorpdfstring{$\mathcal{R}_{pP}$}{RpP}}
\subsection{\texorpdfstring{$\mathcal{R}_{pS}$}{RpS}}
\subsection{\texorpdfstring{$\mathcal{R}_{sP}$}{RsP}}
