...
From
\begin{eqnarray}\label{dnm1}
\int_\gO u_{m\bfk}u^*_{n\bfk}d\bfr=\gd_{nm},
\end{eqnarray}
we easily find that
\begin{eqnarray}\label{dnm2}
\int_\gO d\bfr
...
\end{eqnarray}
Then,
\begin{eqnarray}\label{conmri3}
\bra{n\bfk}[\hat\bfr_i,\hat\calo]\ket{m\bfk'}
=i\gd(\bfk-\bfk')(\calo_{nm})_{;\bfk}
,
\end{eqnarray}   
with
\begin{eqnarray}\label{gendev}
(\calo_{nm})_{;\bfk}=
\nabla_\bfk
\calo_{n m}(\bfk)
-  
