...
we conveniently collect the terms in columns of $\omega$ and $2\omega$. We can now express the susceptibility in terms of $\omega$ and $2\omega$. Separating the $2\omega$ terms and substituting in \eqref{intra_first}, % what about the two and the omega out front?
...
We do the same for the $\omega$ terms in \eqref{simplified_i} and substitute in \eqref{intra_first},
