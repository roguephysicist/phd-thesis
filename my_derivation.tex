...
and we reduce in the same way as \eqref{2wchii}, % follow the derivation in the uncorrected doc, especially for the chain rule to see where this extra 2 comes from
